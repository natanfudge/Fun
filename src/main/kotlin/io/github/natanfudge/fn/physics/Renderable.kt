...
//import io.github.natanfudge.fn.network.IFun
...
//
//
//class FunTransform(parent: IFun) : Fun(parent, "transform") {
//    val positionState = funValue<Vec3f>(Vec3f.zero(), "translation")/* {
//        updateMatrix(position = it)
//    }*/
//    val rotationState = funValue<Quatf>(Quatf.identity(), "rotation")/* {
//        updateMatrix(orientation =  it)
//    }*/
//    val scaleState = funValue<Vec3f>(Vec3f.zero(), "scaling")/* {
...
////        this.matrix = Mat4f.translateRotateScale(position, orientation, scale)
////    }
////
...
//
//
//     var translation by positionState
//     var rotation by rotationState
//     var scale by scaleState
//    fun getMatrix() = Mat4f.translateRotateScale(translation, rotation, scale)
//
//}
//
...
//     */
//    final override var transform: Mat4f = Mat4f.translateRotateScale(translation, rotation, scale)
//        private set
//
//
