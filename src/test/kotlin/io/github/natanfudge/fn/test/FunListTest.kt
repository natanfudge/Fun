...
//        val serverInventory = GameInventory("test-inventory", multiplayer.server)
//
...
//
//        // Server adds an item
//        serverInventory.items.add("Sword")
//
//        // Verify item is synchronized to clients
...
//
//        // Server adds another item
//        serverInventory.items.add("Shield")
//
...
//        serverInventory.items.addAll(listOf("Sword", "Shield", "Potion"))
...
//
////         Test set operation
//        serverInventory.items[1] = "Large Shield"
...
//        val removeResult = serverInventory.items.remove("Potion")
...
//        val removedItem = serverInventory.items.removeAt(0)
...
//        serverInventory.items.add(0, "Helmet")
...
//        serverInventory.items.addAll(1, listOf("Gloves", "Boots"))
...
//        val removeAllResult = serverInventory.items.removeAll(listOf("Gloves", "Boots"))
...
//        // Create a game inventory with initial items for server
//        val serverInventory = GameInventoryWithInitialItems("test-inventory", multiplayer.server)
//
//        // Verify initial state is synchronized
...
//
//        // Server modifies the list
//        serverInventory.initialItems.remove("Shield")
//
